    ...
    try
     ...
     IdHTTP := TIdHTTP.Create(nil);
      ...
      //  filenametest :=  TranslitRus2Lat('d:\14552090 Елизарьев СВ Калинин ИЮ_test.docx');
        ...
        filenametest :=  UTF8Encode('d:\Документы и инструкции\14552090 Елизарьев СВ Калинин ИЮ.docx');
        with MultiData.AddFile('filename[0]',UTF8Encode(filenametest),'') do              //добавляем файл
          begin
            HeaderCharset := 'utf-8';
            HeaderEncoding := '8';
          end;
